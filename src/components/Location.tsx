...
const Location = () => {
  ...
  return <section id="location" className="py-20 section-gradient">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16 animate-fade-in">
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">Strategiczne położenie w Dąbrówce Ług łączy spokój wiejskiego życia z naturą</p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
            ...
            <Card className="card-gradient border-0 shadow-medium overflow-hidden">
              <CardContent className="p-0">
                <div className="relative">
                  <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2445.123456789!2d22.289123456!3d52.167890123!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2sDąbrówka%20Ług!5e0!3m2!1spl!2spl!4v1234567890" width="100%" height="400" style={{
                  border: 0
          ...
          <div className="order-1 lg:order-2">
            ...
            <div className="space-y-6">
              {nearbyPlaces.map((place, index) => <Card key={index} className="card-gradient hover-lift border-0 shadow-soft animate-slide-up" style={{
