...
import { Layout, TreePine, MapPin, Shield, Home, Laptop } from 'lucide-react';
const Features = () => {
  const features = [{
    icon: Layout,
  ...
  return <section id="features" className="py-20 bg-primary/5">
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => <Card key={index} className="card-gradient hover-lift border-0 shadow-soft animate-slide-up group" style={{
        ...
        <div className="text-center mt-16">
          <div className="bg-primary/10 rounded-2xl p-8 md:p-12 max-w-4xl mx-auto">
            <h3 className="font-playfair text-2xl md:text-3xl font-bold text-foreground mb-4">Nie czekaj i zapytaj o więcej szczegółów.</h3>
            <p className="text-lg text-muted-foreground mb-6 max-w-2xl mx-auto">Umów spotkanie — odpowiemy na wszystkie pytania telefonicznie lub mailowo i pokażemy Ci inwestycję na żywo.</p>
